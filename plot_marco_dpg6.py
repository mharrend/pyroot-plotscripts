...
# Jet pt select
jetpT30='(Jet_Pt>35 && Jet_GenJet_Pt>30 && GenEvt_I_TTPlusBB==1)'
jetpT20='(Jet_Pt>35 && Jet_GenJet_Pt>20 && GenEvt_I_TTPlusBB==1)'

# samples
samples=[Sample('t#bar{t}+b',ROOT.kRed+1,'/nfs/dust/cms/user/mharrend/ttbbstudies/results/ttbb_sl/*.root',jetpT20), Sample('t#bar{t}+b2',ROOT.kBlue,'/nfs/dust/cms/user/mharrend/ttbbstudies/results/ttbb_sl/*.root',jetpT30) ]
...
writeListOfHistoLists(listOfhistoLists,samples,"ttb (GenjetPt > 20 GeV) vs. ttb (GenjetPt > 30 GeV)", "ttbttbComparison11")
