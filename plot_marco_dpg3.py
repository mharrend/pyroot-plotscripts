...
# s6j4t selection
    ...
    Plot(ROOT.TH1F("N_TotalTags" ,"Number of total tags ",9,-0.5,8.5),"N_TotalTags",s6j4t),
    Plot(ROOT.TH1F("N_GoodTags" ,"Number of good tags ",9,-0.5,8.5),"N_GoodTags",s6j4t),
    Plot(ROOT.TH1F("N_MisTags" ,"Number of mistags ",9,-0.5,8.5),"N_MisTags",s6j4t),
 
]

listOfhistoLists=createHistoLists_fromTree(plots,samples,'MVATree')
writeListOfHistoLists(listOfhistoLists,samples,"ttbb (GenjetPt > 20 GeV vs. ttbb (GenjetPt > 25 GeV)", "ttbbttbbComparison5")
