...
# Jet pt select
jetpT40='(Jet_Pt>45 && Jet_GenJet_Pt>40)'
jetpT20='(Jet_Pt>45 && Jet_GenJet_Pt>20)'

# samples
samples=[Sample('t#bar{t}+b#bar{b}',ROOT.kRed+1,'/nfs/dust/cms/user/mharrend/ttbbstudies/results/ttbb_sl/*.root',jetpT20), Sample('t#bar{t}+b#bar{b}2',ROOT.kBlue,'/nfs/dust/cms/user/mharrend/ttbbstudies/results/ttbb_sl/*.root',jetpT40) ]
...
writeListOfHistoLists(listOfhistoLists,samples,"ttbb (GenjetPt > 20 GeV) vs. ttbb (GenjetPt > 40 GeV)", "ttbbttbbComparison14")
