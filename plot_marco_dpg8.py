...
# Jet pt select
jetpT30='(Jet_Pt>35 && Jet_GenJet_Pt>80 && GenEvt_I_TTPlusBB==3)'
jetpT20='(Jet_Pt>35 && Jet_GenJet_Pt>20 && GenEvt_I_TTPlusBB==3)'

# samples
samples=[Sample('t#bar{t}+b#bar{b} Gen-Jet pT 20 GeV',ROOT.kRed+1,'/nfs/dust/cms/user/matsch/ntuples/Spring17/v2/ttbar_incl/*.root',jetpT20), Sample('t#bar{t}+b#bar{b} Gen-Jet pT 30 GeV',ROOT.kBlue,'/nfs/dust/cms/user/matsch/ntuples/Spring17/v2/ttbar_incl/*.root',jetpT30) ]
...
writeListOfHistoLists(listOfhistoLists,samples,"", "ttbbttbbComparison16")
